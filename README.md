...
* [provider](resources/provider/provider-configuration.properties)
* [consumer](resources/consumer/consumer-configuration.properties)
...
```bash
java -Dedc.keystore=certs/cert.pfx -Dedc.keystore.password=123456 -Dedc.vault=resources/provider/provider-vault.properties -Dedc.fs.config=resources/provider/provider-configuration.properties -jar connector/build/libs/connector.jar
```
...
```bash
java -Dedc.keystore=certs/cert.pfx -Dedc.keystore.password=123456 -Dedc.vault=resources/consumer/consumer-vault.properties -Dedc.fs.config=resources/consumer/consumer-configuration.properties -jar connector/build/libs/connector.jar
```
